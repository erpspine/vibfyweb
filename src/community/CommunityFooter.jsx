...
import { hostState } from './hostLinks'
...
export default function CommunityFooter() {
  ...
  return <footer className="community-footer">
    ...
    <div className="community-footer-grid">
      ...
      <nav aria-label="Vibfy community"><h3>Be part of it</h3><CommunityLink to="/signup">Join the community</CommunityLink>{session?.token && <CommunityLink to={host.to}>{host.label}</CommunityLink>}<CommunityLink to="/bookings">My bookings</CommunityLink><CommunityLink to="/login">Member login</CommunityLink></nav>
